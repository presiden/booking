...
CREATE TABLE IF NOT EXISTS booking (
    ...
    status booking_status NOT NULL, ---- SELECTED, BOOKED, CANCELLED, EXPIRED
...
CREATE TABLE IF NOT EXISTS payment (
    ...
    booking_id BIGINT NOT NULL,
    payment_method payment_method NOT NULL, --VA, Gopay, OVO, QRIS, etc
    payment_time timestamp NOT NULL,
    amount NUMERIC(10,2) NOT NULL,
    status payment_status NOT NULL, ---- PENDING, SUCCESS, FAILED, CANCELLED, EXPIRED
...
CREATE TABLE IF NOT EXISTS payment_detail (
    ...
    type payment_amount_type NOT NULL, -- BASE, DISCOUNT, ADMIN_FEE, TAX, OTHERS
    description TEXT,
    amount NUMERIC(10,2) NOT NULL,
