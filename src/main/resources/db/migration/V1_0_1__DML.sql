...
INSERT INTO users (username, fullname, email, phone_number, password, birth_date, image_path, is_active)
...
INSERT INTO film (id, title, description, languages_id, duration, image_path, trailer_path, release_date, rating, is_active) VALUES
  (1, 'Edge of Tomorrow', 'Sci-fi action thriller.', 1, 110, 'img1.jpg', 'trailer1.mp4', NOW(), 'D', TRUE),
  (2, 'Spirited Away', 'Japanese fantasy animation.', 3, 125, 'img2.jpg', 'trailer2.mp4', NOW(), 'BO', TRUE),
  (3, 'Parasite', 'Thrilling social drama.', 2, 132, 'img3.jpg', 'trailer3.mp4', NOW(), 'R', TRUE),
  (4, 'Interstellar', 'Epic space exploration.', 1, 169, 'img4.jpg', 'trailer4.mp4', NOW(), 'D', TRUE),
  (5, 'Joker', 'Psychological thriller.', 1, 122, 'img5.jpg', 'trailer5.mp4', NOW(), 'R', TRUE),
  (6, 'Avengers: Endgame', 'Superhero finale.', 1, 182, 'img6.jpg', 'trailer6.mp4', NOW(), 'D', TRUE),
  (7, 'The Godfather', 'Crime family epic.', 1, 175, 'img7.jpg', 'trailer7.mp4', NOW(), 'R', TRUE),
  (8, 'The Dark Knight', 'Batman vs Joker.', 1, 152, 'img8.jpg', 'trailer8.mp4', NOW(), 'D', TRUE),
  (9, 'La La Land', 'Musical romance.', 4, 128, 'img9.jpg', 'trailer9.mp4', NOW(), 'D', TRUE),
  (10, 'Inception', 'Dream within dreams.', 1, 148, 'img10.jpg', 'trailer10.mp4', NOW(), 'D', TRUE),
  (11, 'Soul', 'Animated jazz journey.', 1, 100, 'img11.jpg', 'trailer11.mp4', NOW(), 'BO', TRUE),
  (12, 'Coco', 'Day of the Dead adventure.', 5, 105, 'img12.jpg', 'trailer12.mp4', NOW(), 'BO', TRUE),
  (13, 'Your Name', 'Body-swapping teens.', 3, 106, 'img13.jpg', 'trailer13.mp4', NOW(), 'BO', TRUE),
  (14, 'Dune', 'Sci-fi desert saga.', 1, 155, 'img14.jpg', 'trailer14.mp4', NOW(), 'D', TRUE),
  (15, 'Titanic', 'Epic romance disaster.', 1, 194, 'img15.jpg', 'trailer15.mp4', NOW(), 'D', TRUE),
  (16, 'Get Out', 'Psychological horror.', 1, 104, 'img16.jpg', 'trailer16.mp4', NOW(), 'R', TRUE),
  (17, 'Whiplash', 'Intense jazz drama.', 1, 107, 'img17.jpg', 'trailer17.mp4', NOW(), 'R', TRUE),
  (18, 'The Matrix', 'Virtual reality rebellion.', 1, 136, 'img18.jpg', 'trailer18.mp4', NOW(), 'R', TRUE),
  (19, 'Inside Out', 'Emotions adventure.', 1, 95, 'img19.jpg', 'trailer19.mp4', NOW(), 'BO', TRUE),
  (20, 'The Notebook', 'Romantic drama.', 2, 123, 'img20.jpg', 'trailer20.mp4', NOW(), 'D', TRUE);
